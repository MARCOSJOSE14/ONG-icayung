            ...
            <div className="container flex flex-col gap-6 px-5 py-10 lg:flex-row lg:justify-evenly">
                ...
                <div>
                    ...
                    <div className='text-slate-300  flex flex-col gap-5 my-3'>
                        ...
                        <a className="flex gap-2 hover:font-bold underline underline-offset-2" href="https://wa.me/51982262262?text=Hola,%20quiero%20unirme%20al%20voluntariado" target='_blank' rel="noreferrer">
